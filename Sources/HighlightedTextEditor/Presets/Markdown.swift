...
#if os(macOS)
let codeFont = NSFont.monospacedSystemFont(ofSize: NSFont.systemFontSize * 1.45, weight: .regular)
...
#else
let codeFont = UIFont.monospacedSystemFont(ofSize: UIFont.systemFontSize * 1.40, weight: .regular)
